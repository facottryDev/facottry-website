...
const Button = ({label, link} : Props) => {
    return (
        <div>
            <Link href={link} className="relative inline-flex items-center justify-center p-4 px-8 py-3 overflow-hidden font-medium text-cyan-600 rounded-full shadow-2xl group">
