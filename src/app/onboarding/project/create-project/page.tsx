        ...
        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <p className="mb-2 text-sm text-gray-500 dark:text-gray-400">
              Join existing project? <Link href="/onboarding/project/join-project" className="font-semibold text-primary-600 hover:underline dark:text-primary-500">Click Here</Link>
            </p>
