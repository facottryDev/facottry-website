            ...
            <div className="w-full bg-white shadow-lg border rounded-lg dark:border md:mt-0 sm:max-w-lg xl:p-0 dark:bg-darkblue dark:border-slate-700">
                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-4">
                            <label htmlFor="employees" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Invite Employees</label>
                            <textarea name="employees" id="employees" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter comma-separated emails" />
                        </div>
                        ...
                        <p className="mb-2 text-sm text-gray-500 dark:text-gray-400">
                            Join existing company? <Link href="/onboarding/join-company" className="font-semibold text-primary-600 hover:underline dark:text-primary-500">Click Here</Link>
                        </p>
