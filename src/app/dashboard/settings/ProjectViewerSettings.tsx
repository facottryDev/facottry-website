...
export default function ProjectViewerSettings() {
    ...
    return (
        <div className="p-4 bg-white rounded-lg dark:bg-darkblue">
            <div className="pb-6 border- border-gray-900/10 dark:border-gray-500">
                <h2 className="text-base font-semibold leading-7 text-gray-900 dark:text-slate-200">Project Viewer Settings</h2>
